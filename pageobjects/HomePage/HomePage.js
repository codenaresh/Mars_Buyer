...
HomePage = function() {
	...
	var browseProduct = element(by.xpath("//button[contains(text(),'Browse Products')]"));

	var myOrder = element(by.xpath('//a[contains(text(),"My Orders")]'));
	
	var home = element(by.xpath('//a[contains(text(),"Home")]'));
	
	var resousrce= element(by.xpath("//button[contains(text(),'Resources')]"));
	
	var searchoption=	element(by.xpath("//*[@id='search-addon']"));
	...
	var copyrightext=element(by.xpath("//small[contains(text(),'Copyright © 2020, Archway. All rights reserved.')]]"));
	
	// feature item
	
	var featureitem= element(by.xpath("//*[text()='Featured Products']"));
