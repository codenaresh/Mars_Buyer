...
CheckOut = function() {
	...
	var submitOrder = element(by.xpath("//button[text()='Confirm Order']"));
...
var costcenter=element(by.xpath("//input[@id='costCenter']"));


this.entercostcenter= function(value){
	
	costcenter.clear();
	
	costcenter.sendKeys(value);
	
};

this.calendardate=function(datevalue){
	
	browser.executeScript("document.getElementById('promisedByDate').value='+"+datevalue+"+'");	
